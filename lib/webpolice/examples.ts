...
export const POOL_ES: SiteRef[] = [
  ...
  // More recognisable Spanish sites so the "Try random" pool has real variety.
  site('Iberia', 'iberia.com', 'good', 'https://www.iberia.com/'),
  site('Vueling', 'vueling.com', 'good', 'https://www.vueling.com/'),
  site('Air Europa', 'aireuropa.com', 'rough', 'https://www.aireuropa.com/'),
  site('BBVA', 'bbva.es', 'good', 'https://www.bbva.es/'),
  site('Banco Santander', 'bancosantander.es', 'rough', 'https://www.bancosantander.es/'),
  site('CaixaBank', 'caixabank.es', 'rough', 'https://www.caixabank.es/'),
  site('Bankinter', 'bankinter.com', 'rough', 'https://www.bankinter.com/'),
  site('Movistar', 'movistar.es', 'rough', 'https://www.movistar.es/'),
  site('Vodafone', 'vodafone.es', 'rough', 'https://www.vodafone.es/'),
  site('Iberdrola', 'iberdrola.es', 'good', 'https://www.iberdrola.es/'),
  site('Endesa', 'endesa.com', 'rough', 'https://www.endesa.com/'),
  site('Mapfre', 'mapfre.es', 'rough', 'https://www.mapfre.es/'),
  site('Repsol', 'repsol.com', 'good', 'https://www.repsol.com/'),
  site('Desigual', 'desigual.com', 'good', 'https://www.desigual.com/'),
  site('Camper', 'camper.com', 'good', 'https://www.camper.com/'),
  site('Tous', 'tous.com', 'good', 'https://www.tous.com/'),
  site('Freixenet', 'freixenet.es', 'rough', 'https://www.freixenet.es/'),
  site('Decathlon', 'decathlon.es', 'rough', 'https://www.decathlon.es/'),
  site('Leroy Merlin', 'leroymerlin.es', 'rough', 'https://www.leroymerlin.es/'),
  site('Fnac', 'fnac.es', 'rough', 'https://www.fnac.es/'),
  site('Sport', 'sport.es', 'rough', 'https://www.sport.es/'),
  site('Mundo Deportivo', 'mundodeportivo.com', 'rough', 'https://www.mundodeportivo.com/'),
  site('El Español', 'elespanol.com', 'rough', 'https://www.elespanol.com/'),
]
