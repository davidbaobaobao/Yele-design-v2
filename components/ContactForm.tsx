...
export default function ContactForm({ waLink }: { waLink?: string } = {}) {
  ...
  return (
    <section id="contacto" className="relative overflow-hidden py-24 md:py-32 bg-ink">
      <InfiniteGrid />
      <div className="relative z-10 max-w-3xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <span className="font-body text-xs tracking-[0.15em] uppercase text-white/30 mb-4 block">
            {t('Contacto', 'Contact')}
          </span>
          <h2 className="font-display font-semibold text-4xl md:text-5xl text-white tracking-tight mb-4">
        ...
        {waLink && (
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2.5 font-body font-semibold text-base bg-[#25D366] text-white px-7 py-4 rounded-2xl hover:bg-[#20B858] transition-colors"
            >
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <span className="font-body text-xs text-white/30 uppercase tracking-wider">o por formulario</span>
              <div className="flex-1 h-px bg-white/10" />
            </div>
          </motion.div>
        )}
