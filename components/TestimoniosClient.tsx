            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-manrope text-xs text-[#6B7280] font-medium">Google</span>
                </div>
                <div className="flex gap-0.5">
                  {Array.from({ length: 5 }).map((_, s) => (
                    <svg key={s} viewBox="0 0 20 20" className="w-4 h-4 fill-[#FBBC05]" aria-hidden="true">
              ...
              <footer>
                ...
                <p className="font-manrope text-xs text-[#6B7280] mt-0.5">{item.role}</p>
              </footer>
            </div>
          ))}
        </motion.div>
