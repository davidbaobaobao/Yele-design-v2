    ...
    <section className="py-24 md:py-32 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-[#1D1D1F]"
          style={{
            background: 'radial-gradient(ellipse 80% 60% at 30% 0%, rgba(52,199,89,0.12) 0%, transparent 60%), #1D1D1F',
          }}
        >
          {/* Decorative green glow */}
          <div className="absolute top-0 left-0 w-64 h-px bg-gradient-to-r from-transparent via-[#34C759]/40 to-transparent" aria-hidden="true" />
          ...
          <div className="grid md:grid-cols-2 gap-0 items-center">
            ...
            <div className="px-8 py-16 md:px-14 md:py-20">
              ...
              <p className="font-manrope text-white/50 text-lg mb-10 max-w-sm">
                {t(
            ...
            <div className="relative hidden md:flex items-center justify-center px-8 py-10 h-full">
              <div className="relative w-full rounded-2xl overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.4)]">
                <video
                  autoPlay
                  muted
                  loop
                  ...
                  aria-hidden="true"
                >
                  <source src="/video/hero-dash.mp4" type="video/mp4" />
                </video>
              </div>
            </div>
