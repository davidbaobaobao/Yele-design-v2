...
import ShowcaseHeroClient from './ShowcaseHeroClient'
...
export default async function ShowcaseHero({ noBg }: { noBg?: boolean } = {}) {
  ...
  return <ShowcaseHeroClient projects={projects} noBg={noBg} />
}
