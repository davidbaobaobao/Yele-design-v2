              ...
              <div className="flex items-center" aria-hidden="true">
                {AVATARS.map((src, i) => (
                  ...
                  >
                    ...
                    {/* Subtle brand-pink tint over the photo — soft-light keeps
                        the underlying image visible instead of flattening it
                        into a solid color like a normal opacity overlay would. */}
                    <div
