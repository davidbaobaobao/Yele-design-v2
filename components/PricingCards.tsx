...
// The 3 pricing cards themselves — extracted out of PreciosIndexSection so
// /services (Essential Packages) can render the EXACT same cards/data/CTAs
// without duplicating them; PreciosIndexSection now just wraps this grid
...
// The 3-card grid on its own, no heading/section chrome — callers own
// their own heading, background and surrounding copy.
