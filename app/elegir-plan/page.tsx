...
const PLANS = [
  ...
  },
  {
    ...
    annualMonthly: PLAN_PRICES.pro.annualMonthly,
    annualTotal: PLAN_PRICES.pro.annualTotal,
    features: [
  ...
  },
  {
    ...
    monthlyPrice: PLAN_PRICES.frontier.monthly,
    annualMonthly: PLAN_PRICES.frontier.annualMonthly,
    annualTotal: PLAN_PRICES.frontier.annualTotal,
    features: [
      'Todo lo de Pro, más:',
