...
export const metadata: Metadata = {
  ...
  description:
    'Web profesional para electricistas lista en 5 días. Aparece en Google cuando te buscan en tu zona. Sin pago inicial, desde 29€/mes, sin permanencia.',
  alternates: {
  ...
  openGraph: {
    title: 'Diseño web para electricistas — más clientes desde Google | Yele',
    description:
      'Web profesional para electricistas lista en 5 días. Sin pago inicial, desde 29€/mes, sin permanencia.',
