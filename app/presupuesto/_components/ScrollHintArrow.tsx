...
export default function ScrollHintArrow() {
  ...
  return (
    <div className="flex justify-center pt-6">
      ...
      >
        <div className="w-11 h-11 rounded-full border border-[#1D1D1F]/20 bg-white/70 backdrop-blur-sm flex items-center justify-center shadow-sm hover:bg-white transition-colors">
